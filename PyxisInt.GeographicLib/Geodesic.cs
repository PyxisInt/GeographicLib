...
namespace PyxisInt.GeographicLib
{
     ...
     * optional readonly argument <i>outmask</i> which allows you specify which
            ...
            else
            {
                ...
                if (y > -tol1_ && x > -1 - xthresh_)
                {
                    ...
                    else
                    {
                        ...
                        w.salp1 = Math.Sqrt(1 - GeoMath.Square(w.calp1));
                    }
                }
                else
                {
                    ...
                    w.salp1 = cbet2 * somg12;
                    w.calp1 = sbet12a - cbet2 * sbet1 * GeoMath.Square(somg12) / (1 - comg12);
                }
            }
